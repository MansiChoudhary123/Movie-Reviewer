...
const AddMovie = () => {
  ...
  function validateForm(form) {
    ...
    if (form.title.trim() === "") {
      ...
      errors.push("Title should not be atleast 2 characters long");
    }

    if (form.poster_path.trim() === "") {
      errors.push("Poster path is required");
    }

    if (form.backdrop_path.trim() === "") {
      errors.push("Backdrop path is required");
    }
    ...
    if (form.original_language.trim() === "") {
      errors.push("Original language is required");
    } else if (form.original_language.length <= 2) {
      errors.push("Original language should be a 2-character code");
    }

    if (form.overview.trim() === "") {
      errors.push("Overview is required");
    } else if (form.overview.length < 50) {
      errors.push("Overview should not less than 50 characters");
    }
